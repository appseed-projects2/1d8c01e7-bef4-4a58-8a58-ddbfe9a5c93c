...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-25 15:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1d8c01e7-bef4-4a58-8a58-ddbfe9a5c93c.git
$ cd 1d8c01e7-bef4-4a58-8a58-ddbfe9a5c93c
```
